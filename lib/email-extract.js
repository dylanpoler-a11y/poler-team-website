...
- "Mitch Rodriguez" / "Maikel Rodriguez" / "Mitch" / "Maikel" / "Mitch & Maikel" / "Marcel" (Royal SB board) → MR9 Holdings (reckHRUqpAiRlw4Yl) AND Brickell Travel (recljWqJPnttwYkzp) — emit BOTH refs
- "Royal" / "Royal South Beach" / "Royal SB" / "Dream Inn" → MR9 Holdings + Brickell Travel (same client group)
- "AD1" / "AD1 Global" / "AD1 Hospitality" / "Alex Fridzon" / "Gisela" / "Gisela Levy" → AD1 Global (recoUF9Pc03xFTuSO)
...
- "Contempora" / "Save" / "Gonzalo Martino" / "Gonzalo Martino González" / "MPG office" → Contempora / Save (recUcvgndm9SCC2gd)
