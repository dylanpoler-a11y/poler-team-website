...
- "AD1" / "AD1 Global" / "AD1 Hospitality" / "Alex Fridzon" (alex.fridzon@ad1hospitality.com) / "Gisela" / "Gisela Levy" (gisela.levy@ad1growth.com) / @ad1hospitality.com / @ad1growth.com → AD1 Global (recoUF9Pc03xFTuSO)
  AD1 KNOWN DEALS — when matched in dealList, emit dealReferences; if no match, emit clientReferences only. **DO NOT emit newDealCandidates and DO NOT invent dealValue / monthlyRecurringFee / probability from prose.** Deal creation + fee structure is a manual call by Kevin. (Trace: 2026-05-19 cleanup — Sonnet was extracting acquisition-target prices, capital-required figures, and NOI projections from deck prose and dropping them into dealValue, creating 5 phantom MR9 deals with wrong values.):
