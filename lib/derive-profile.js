...
// Kevin 2026-09-17: every site-derived (auto) profile is WEEKLY regardless of the
// timeline pill — a lead who only browsed a few listings still gets properties every
// week, not monthly. The timeline argument is kept for callers/tests; it no longer
// changes the answer. (Pre-2026-09-17: Weekly 0–6 mo / Bi-Weekly 6–12 / Monthly 12+.)
export function frequencyForTimeline(timeline) { // eslint-disable-line no-unused-vars
    return 'Weekly';
}
